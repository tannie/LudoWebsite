...
BLOG_AUTHOR = "Ludo"  # (translatable)
BLOG_TITLE = "Ludo"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://ludo.events/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://ludo.events/"
BLOG_EMAIL = ""
BLOG_DESCRIPTION = "Let's play!"  # (translatable)
...
# #         ("/eo/news", "News"),
        ("/schedule", "Programo"),
        ("/registration", "Aliĝado"),
        ("/directions", "Loko + Kiel atingi"),
        ("/games", "Ludoj"),
        ("/contact-form", "Kontakto/Impressum"),
    ),
#            "de": (
#        ("/de/", "Home"),
##         ("/de/news", "News"),
...
#LOGO_URL = 'https://lh3.googleusercontent.com/wuPOMAUxc7LgyilijCr3G9U3ewfDQkEdJZKzWIsjy2ffUYg5MnX7orR0u05sAtiQM3LTEEaSz92AGs3Gb7Upj8-_vWHPk4WeJSFvMFEKr5MX0XyCo_gRIBU8kdEEtE7H4g=w1280'
